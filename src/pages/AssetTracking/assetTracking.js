...
import AssetTrackingCard from "../../components/AssetTrackingCards/assetTrackingCard";
  ...
  return (
    <>
      ...
      <IonGrid className='asset-grid'>
        <IonRow>
          <IonCol>
            <AssetTrackingCard cardSvg={NoItems} cardText='No. of Items' imgHeight='50px' imgWidth='50px' route='noOfItems'/>
          </IonCol>
          <IonCol>
